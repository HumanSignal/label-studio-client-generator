...
4. Convert the export to a specified format (optional and only if `LABEL_STUDIO_EXPORT_TYPE` is specified)
5. Poll for conversion completion
6. Download the resulting converted file

### Set environment variables

See [Authenticate and Connect to the API](../../api-reference/introduction/getting-started#authenticate-and-connect-to-the-api).

- `LABEL_STUDIO_URL`: Your Label Studio URL (e.g. `https://app.humansignal.com`)
- `LABEL_STUDIO_API_KEY`: Your personal access token. You can generate this from your **Account & Settings** page. 
- `LABEL_STUDIO_PROJECT_ID`: Numeric project ID. You can find this in the URL for the project, e.g. `https://app.humansignal.com/projects/<PROJECT_ID>`. 
- `LABEL_STUDIO_EXPORT_TYPE`: The type of export (CSV, COCO, JSON, etc.) to convert to. This is optional, and the default is JSON
...
LABEL_STUDIO_PROJECT_ID="123456" \
...
Read more about export formats in the [Label Studio documentation](https://labelstud.io/guide/export).