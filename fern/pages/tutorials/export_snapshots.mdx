...
LABEL_STUDIO_API_KEY = 'YOUR_ACCESS_TOKEN'
...
You can also find this as a [Python script in the SDK repo](https://github.com/HumanSignal/label-studio-sdk/blob/master/tutorials/export_snapshots.py). Note that in that example, you must first set the URL, API key (access token), and project ID as environment variables. 
