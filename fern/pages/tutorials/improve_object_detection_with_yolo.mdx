...
You can collect object detections from the model and convert it to [Label Studio JSON format](https://labelstud.io/guide/tasks.html#Basic-Label-Studio-JSON-format).
