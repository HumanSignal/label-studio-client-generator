<Warning> Version 2.0.0 of the Label Studio SDK is coming soon, and will contain breaking changes. If you use the Label Studio SDK package in any automated pipelines, we strongly recommend pinning your SDK version to `<2.0.0`. </Warning>
